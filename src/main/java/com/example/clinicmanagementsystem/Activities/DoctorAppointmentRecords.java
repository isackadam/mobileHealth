...
public class DoctorAppointmentRecords extends AppCompatActivity implements AppointmentViewFetchData {
    ...
    public void onUpdateSuccess(AppointmentInfo message) {
        if(message != null){
            if(message.getDoctorEmail().equals(femail)){
    ...
    public void onUpdateFailure(String message) {
        Toast.makeText(DoctorAppointmentRecords.this, message, Toast.LENGTH_LONG).show();
    }

    @Override
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(DoctorAppointmentRecords.this, AdminPanel.class);
