...
public class PatientAppointmentRecords extends AppCompatActivity implements AppointmentViewFetchData {
    ...
    public void onUpdateFailure(String message) {
        Toast.makeText(PatientAppointmentRecords.this, message, Toast.LENGTH_LONG).show();
    }

    @Override
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(PatientAppointmentRecords.this, AdminPanel.class);
