...
public class AppointmentSchedule extends AppCompatActivity implements AppointmentViewFetchData {
    ...
    public void onUpdateFailure(String message) {
        Toast.makeText(AppointmentSchedule.this, message, Toast.LENGTH_LONG).show();
    }

    @Override
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(AppointmentSchedule.this, DoctorPanel.class);
